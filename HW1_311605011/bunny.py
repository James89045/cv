...
for i in range(IMG1.shape[0]):
    for j in range(IMG1.shape[1]):
        ...
        #print(n.shape)
            normal_image[i][j] = n
#normal_image = ((normal_image*0.5 + 0.5)*255).astype(np.uint8)
normal_visualization(normal_image, IMG1.shape[0], IMG1.shape[1], "bunny_normal.png")
...
#giving those pixels whose value are not zero ID
...
print("max z value: ", max(zl))
depth_visualization(Z, IMG1.shape[0], IMG1.shape[1], "bunny_depth.png")
save_ply(Z, "bunny.ply", IMG1.shape[0], IMG1.shape[1])
show_ply("bunny.ply")