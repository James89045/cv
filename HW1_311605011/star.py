...
normal_visualization(normal_image, IMG1.shape[0], IMG1.shape[1], "star_normal.png")
...
for i in range(pix_num):
    ...
    w = nonzero_w[i]
    Z[h, w] = z[i]
depth_visualization(Z, IMG1.shape[0], IMG1.shape[1], "star_depth.png")
save_ply(Z, "star.ply", IMG1.shape[0], IMG1.shape[1])
show_ply("star.ply")