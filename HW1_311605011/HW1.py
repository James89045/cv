...
def normal_visualization(N, image_row, image_col, save_name):
...
def depth_visualization(D, image_row, image_col, save_name):
...
def save_ply(Z, filepath, image_row, image_col):
    ...
    _, idx = pcd.remove_statistical_outlier(20, 1)
    inlier_cloud = pcd.select_by_index(idx)
